...
transactions are needed. As an example, given that currently in bitcoin $|\chain| =
...
\footnote{Our experiment can be reproduced by running our code available under
