...
In this work we introduce, analyze and implement  a new primitive, called Noninteractive-Proofs-of-Proof-of-Work, (NIPoPoWs), which can be adapted into existing cryptocurrencies to support more efficient clients.
