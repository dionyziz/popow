...
scheme is not secure (we illustrate an in attack sufficient to break their
scheme with overwhelming probability in the full version of this paper) nor
succinct against adversarial provers and does not allow the proof of generic
predicates.
