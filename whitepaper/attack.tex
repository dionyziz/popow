...
last $k$ blocks are sent literally as $\chi_B = \chain_B[-k:]$. Then for the
...
blocks after the purported LCA. The security parameter $m$ ensures, through the
application of a binomial Chernoff bound, that the probability of the attacker
...
\begin{figure}
    \caption{The superquality attack.
...
We now calculate the exact attack probabilities
