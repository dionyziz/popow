...
Our work improves and extends on prior work by Kiayias et al. Compared to theirs, our protocol is non-interactive, requiring only one round of communication. We also identify and correct a double-spend vulnerability and proof flaw in the prior work. % Correcting this required \anote{TODO}.
