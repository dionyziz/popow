...
\dznote{In the optimistic case where the adversary plays honestly...}
...
\dznote{Note that this will require relaxing the security with making the
verifier to output $\bot$...}
