\section{Gradual Deployment Without Forks}
...
In this section we outline several possible upgrade paths. We also contribute a novel upgrade approach, called ``velvet forks,'' which allows for gradual deployment without the need for a fork at all.
